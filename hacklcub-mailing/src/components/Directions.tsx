...
function Directions() {
    ...
    setTimeout(() => {
      ...
      directionsService
        .route({
          ...
          destination: toValue?.label || "Rashtrapati Bhavan, New Delhi",
  ...
  return (
    <div className="directions bg-[#fff] p-[20px]" style={{ width: "25vw" }}>
      ...
      <div
        className="mb-[16px] flex justify-between text-[#3B82F6]"
        style={{
          fontWeight: "600",
        }}
      >
              ...
              <div key={i}>
                <div className="flex justify-between">
                  <div className="flex gap-[10px] items-center">
                    ...
                    <div
                      key="stuff"
                      className="ml-[5px] text-gray-700"
                      style={{
                        whiteSpace: "nowrap",
                        overflow: "hidden",
                      ...
                      dangerouslySetInnerHTML={{
                        __html: item.instructions.slice(0, 55),
                      }}
                    ></div>
                  </div>
                  <div className="ml-auto mt-auto mb-auto text-[#3B82F6]">
